                        ...
                        <h5 className="font-medium text-black dark:text-white">
                          <div className="col-span-3 flex items-center">
                            <div className="flex flex-col gap-4 sm:flex-row sm:items-center">
                              <div className="flex h-[48px] w-[48px] items-center justify-center rounded-md">
                                <img src={item.img} alt="Product" />
                              </div>
                              <p className="text-sm font-bold text-black hover:cursor-pointer hover:underline dark:text-white">
                                {item.name}
                              </p>
                            </div>
                          </div>
